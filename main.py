...
# create a function for all belwo code
def fill_form():
    # Navigate to the desired webpage
url = 'https://www.dollarama.com/en-CA/corp/careers/store-position-application-form?position=SA&storeid=572'  # Replace with the URL of the webpage you want to fill data on
driver.get(url)
